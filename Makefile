...
MAKE_LOGFILE = /tmp/spiral-starter-tpl.log
MAKE_CMD_COLOR := $(BLUE)
...
help: ## Show this menu
	...
	@echo
	@echo '    📦 Package                 spiral-starter-tpl (github.com/wayofdev/spiral-starter-tpl)'
...
key: ## Runs artisan command to create app encryption key
	$(APP_RUNNER) php app.php encrypt:key --mount=.env
.PHONY: key
...
download: ## Download composer dependencies
	$(APP_COMPOSER) rr:download
.PHONY: download
